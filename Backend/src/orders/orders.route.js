...
router.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: "https://prajapati-ceramic-frontend-4tbs.vercel.app/success?session_id={CHECKOUT_SESSION_ID}",
      cancel_url:  "https://prajapati-ceramic-frontend-4tbs.vercel.app/cancel",
