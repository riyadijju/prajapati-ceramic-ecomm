...
// POST - Create product with variants and artist
...
// GET - Single product with artist and variants
...
// PATCH - Update product and variants including artist
router.patch("/update-product/:id", verifyToken, verifyAdmin, async (req, res) => {
  try {
    const productId = req.params.id;
    const { variants, artist, ...updateData } = req.body;
